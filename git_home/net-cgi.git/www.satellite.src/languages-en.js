...
password_complex_error="Invalid admin password. Password must be 8-32 characters, contain at least 1 uppercase letter, 1 lowercase letter, 1 number and a special character. Allowed special characters !@#$%^&*()"
...
ap_failure_noip="Your access point has no Internet access. Check to make sure that your router has an Internet connection."
ap_failure_noplug="Your access point has no connection to the router. Check your Ethernet connection."
ap_mark="Access Point"
ca_15_sec="Security Type"
check_oneline_note="Check for a new version online."
connect_status_mark="Connection Status"
ethernet="Ethernet"
EXT_STR0246="CANCEL"
EXT_STR0249="ok"
EXT_STR0292="Your access point is up and running."
EXT_STR0293="Access Point Wireless Settings (2.4GHz)"
EXT_STR0294="Access Point Wireless Settings (5GHz)"
EXT_STR0584="Your Orbi Satellite connection is up and running."
EXT_STR0586="Connection to Existing Network (2.4GHz)"
EXT_STR0587="Connection to Existing Network (5GHz)"
EXT_STR0588="Orbi Satellite WiFi Status (2.4GHz)"
EXT_STR0589="Orbi Satellite WiFi Status (5GHz)"
EXT_STR0597="Move your Orbi satellite closer to your Orbi router to improve the connection."
EXT_STR0622="BROWSE"
EXT_STR0627="Check for Update"
EXT_STR0628="CHECK ONLINE"
EXT_STR0629="Upload Update File"
EXT_STR0630="Locate and select the update file on your device."
EXT_STR0666="Connected Devices"
EXT_STR0701="The Orbi satellite can't connect to the Orbi router."
fw_available="New update is available. Click <a class='fwCheck'>here</a> to start."
info_signal_strength="Signal Strength"
on_acc_schedule="Access Scheduling is currently on."
orbi_satellite_device="Attached Devices"
Orbi_satellite_title="Orbi Satellite"
restarting="Your Orbi satellite is restarting, please wait ..."
router="Router"
upgrade_head2="Firmware Update"
upgrade_mark="Upload"
wait_serv4="Checking for a new update. This may take a minute..."
wifi_extender="Orbi Satellite"
acl_mark="Access Control"
adapter_macaddr="Your wireless adapter MAC address is "
apply_settings="Applying your settings. This may take up to a minute."
basic_settings="Basic Settings"
best_connection="Green indicates <b>best connection</b>"
ca_ap_ssid="SSID"
ca_cancel="Click 'Cancel' to select a different network."
ca_retry_mac="The Extender MAC addresses are "
change_time_to="Do you also want to change internal WiFi Extender clock to "
days="Days"
del_mark="Remove"
deny_mark="Deny"
device_name_empty="Network/Device Name can not be blank!"
enable_ac="Enable Access Control"
error_no_answer="You must enter an answer."
error_no_question="You must select a question."
everyday="Every day"
EXT_STR0605="Disable Access Control"
EXT_STR0665="Network Neighborhood"
EXT_STR0667="Available Space"
...
good_connection="Amber indicates <b>good connection</b>"
have_new_fw="There is a new update available that improves your Orbi satellite. Click UPDATE below to start."
info_signal_strength="Signal Strength"
invalid_emaill="Invalid email address."
invalid_ftp_port="ftp port via internet should be 21 or in the range [1024 ~ 65534] ."
invalid_http_port="http port via internet should be 80 or in the range [1024 ~ 65534] ."
invalid_share_name="Share Name can not contain  &quot; : < > ' |\/ ] "
invalid_time_sel="You must select a valid time."
language="Language"
link_tag="Link"
lower_browser="NETGEAR recommend you to upgrade your Internet Explorer browser to Internet Explorer 8 or higher to use NETGEAR genie for installation."
move_to_extender="Move the computer or mobile device closer to the Orbi satellite."
msg_bookmark="We could not add the bookmark. Add the bookmark directly from your browser."
multi_wait1="Updating your language selection. This may take a minute."
...
new_add_bookmark="Do you want to add NETGEAR genie as a browser bookmark?"
...
not_select_device=""
poor_connection="Red indicates <b>poor connection</b>"
reg_failed="Registration could not be completed at this time. Try again later."
...
res_402="This serial number is already registered in our system. Thank you for registering your product."
res_403="You entered an invalid email address or you did not enter an email address. Try again."
res_404="You entered an invalid first name or you did not enter a first name. Try again."
res_405="You entered an invalid last name or you did not enter a last name. Try again."
res_406="You entered an invalid country code or you did not enter a country code. Try again."
res_407="You provided invalid email information or you did not provide email information. Try again."
res_408="You entered an invalid purchase date or you did not enter a purchase date. Try again."
res_409="You provided invalid data to the rating question. Try again."
res_500="Unknown error. Request failed."
reset_timer="Your session will time out in one minute. Would you like to extend your session for another five minutes?"
retry_mark=" Try again "
sch_reach_limt="The Scheduled Times table supports a maximum of 21 items."
share_name_dup="This Share name has already existed, please change to another one."
share_name_empty="Share Name can not be NULL!"
ssid_invalid="The SSID can use up to 32 alphanumeric characters."
timeout_msg="Your session timed out due to inactivity. Click the OK button to log in again."
timestamp_error="Sorry,your timestamp is expired.<br> Please click the menu to re-enter the page."
total_space="Total Space"
update_file="Thank you for registering your product. This product registration is now a part of your my.netgear.com profile."
upg_2_old="The firmware you are trying to upload is older than the current firmware that is on the Orbi Satellite."
upg_2_same="The firmware you are trying to upload is the same as the current firmware that is on the Orbi Satellite."
upg_continue="Do you still want to continue?"
upgrade_note3="It will take 1-2 minutes to complete the update. Please do not press the reset button or unplug your Orbi satellite."
virtual_macaddr="Virtual MAC Address"
wep_apsame_toclient="The WEP key setting has to be consistent as configured as your existing router's setting"
wg_name_empty="Workgroup can not be NULL!"
...
multi_wait="Downloading and updating the language table, please wait for approximately one minute..."
auto_upg_nowan_head="No Internet Connection"
Orbi_satellite_success="Your Orbi Satellite connection is up and running."
EXT_STR0590="WiFi Analytics App"
EXT_STR0591="Optimize your WiFi network with the free app for Android."
EXT_STR0592="Install Now »"
EXT_STR0593="Need Help?"
EXT_STR0594="Submit a question to our support team over chat, email or phone."
EXT_STR0595="License"
EXT_STR0596="Search Help"
EXT_STR0299="Learn More »"
...
satellite_not_connect="<h1 class=\"margin_bottom_50\">Your Orbi Satellite is not connecting to the Orbi network</h1><p>This is most likely due to one of the following reasons.</p><p><b>1. It might be too far away from Orbi Network</b></p><p>Please turn the Satellite off, move it closer, and back on. Wait 2 minutes for Orbi Satellite to complete start up.</p><p><b>2. Your Orbi Satellite might not setup successfully</b></p><p>Make sure both your Orbi Router and Orbi Satellites are turned on, press SYNC button on both devices. Wait for 2 minutes to complete setup.</p>"
...
error_module="Error upgrade file module name! (Module name is \"RBS20\") "
error_language_form="Incorrect upgrade file language name. (The language name is\"RBS20-*-Language-table\".)"
