...
bh_account_msg="Ο κωδικός πρόσβασης διαχειριστή χρησιμοποιείται για τη σύνδεση στο περιβάλλον χρήσης web του δρομολογητή Orbi. Ασφαλίστε το δίκτυό σας αλλάζοντας τον κωδικό πρόσβασης διαχειριστή."
...
bh_password_null="Ο κωδικός πρόσβασης δεν μπορεί να είναι κενός."
...
bh_orbi_nowan="Δεν έχει συνδεθεί καλώδιο Ethernet στη θύρα Internet του δρομολογητή Orbi"
bh_orbi_nowan_msg="Βεβαιωθείτε ότι το καλώδιο είναι σωστά συνδεδεμένο στη θύρα ευρυζωνικής σύνδεσης του μόντεμ και στη θύρα Internet του δρομολογητή Orbi."
...
bh_orbi_help_choice1="θέλω ο βοηθός εγκατάστασης NETGEAR να καθορίσει τις κατάλληλες ρυθμίσεις για το περιβάλλον μου και να διαμορφώσει αυτόματα το δρομολογητή Orbi."
...
bh_orbi_help_choice3="θέλω να φορτώσω τις αποθηκευμένες ρυθμίσεις διαμόρφωσης του δρομολογητή Orbi."
bh_orbi_nowan_msg1="Βεβαιωθείτε ότι το καλώδιο είναι σωστά συνδεδεμένο στη θύρα ευρυζωνικής σύνδεσης του μόντεμ και στη θύρα Internet του δρομολογητή Orbi."
...
bh_orbi_pppoe_conn="Εντοπίστηκε σύνδεση στο Internet μέσω PPPoE"
...
bh_orbi_cannot_find_ip_msg1="Δεν απενεργοποιήσατε και ενεργοποιήσατε ξανά το μόντεμ όταν σας ζητήθηκε κατά τη διαδικασία της καλωδίωσης."
...
bh_orbi_cannot_find_ip_msg3="Το καλώδιο Ethernet που συνδέει το μόντεμ με το δρομολογητή Orbi δεν έχει τοποθετηθεί τελείως ή έχει τοποθετηθεί σε εσφαλμένο σημείο."
bh_orbi_cannot_find_ip_msg4="Βεβαιωθείτε ότι το καλώδιο Ethernet είναι σωστά συνδεδεμένο στη θύρα του μόντεμ και στη θύρα Internet του δρομολογητή Orbi."
bh_orbi_problem_no_solve="ΤΟ ΠΡΟΒΛΗΜΑ ΔΕΝ ΛΥΘΗΚΕ"
bh_orbi_enter_ip_setting="Εισαγάγετε τις ρυθμίσεις της καθορισμένης διεύθυνσης ΙΡ που σας εκχωρήθηκε από τον πάροχο υπηρεσιών Internet και κάντε κλικ στο κουμπί <b>ΕΠΟΜΕΝΟ</b> για να συνεχίσετε."
...
bh_orbi_restore="Γίνεται επαναφορά των ρυθμίσεων του δρομολογητή Orbi"
bh_orbi_restore_wait="Η διαδικασία ενδέχεται να διαρκέσει μερικά λεπτά."
bh_orbi_restore_msg1="Μεταβείτε στο αντίγραφο ασφαλείας των ρυθμίσεων δρομολογητή Orbi που έχετε αποθηκεύσει και κάντε κλικ στο κουμπί <b>ΕΠΟΜΕΝΟ</b> για να συνεχίσετε."
bh_orbi_sel_file="Επιλογή αρχείου"
bh_orbi_browse_mark="ΑΝΑΖΗΤΗΣΗ"
bh_orbi_back_mark="ΠΙΣΩ"
bh_orbi_cannot_connect_internet="Ο δρομολογητής Orbi δεν μπορεί να συνδεθεί στο Internet με τις τρέχουσες ρυθμίσεις."
bh_orbi_cannot_connect_internet_msg1="Ελέγξτε τα παρακάτω στοιχεία:"
bh_orbi_cannot_connect_internet_msg2="Ελέγξτε αν τα καλώδια έχουν συνδεθεί σωστά. Για περισσότερες πληροφορίες, ανατρέξτε στο συνοπτικό οδηγό του δρομολογητή Orbi."
...
bh_orbi_ap_tips="Σημείωση: Εντοπίστηκε δρομολογητής ή πύλη στο δίκτυό σας. Ο δρομολογητής Orbi μπορεί ακόμη να συνδεθεί στο δίκτυο και θα οριστεί στη λειτουργία δρομολογητή."
bh_orbi_ap_title="Εντοπίστηκε υπάρχων δρομολογητής ή πύλη"
bh_orbi_check_update="Γίνεται έλεγχος για ενημερώσεις"
bh_check_satellite="Γίνεται έλεγχος της σύνδεσης των δορυφόρων Orbi"
...
bh_orbi_print="ΕΚΤΥΠΩΣΗ ΣΤΟΙΧΕΙΩΝ ΣΥΝΔΕΣΗΣ WI-FI"
bh_orbi_no_satellite="Δεν εντοπίστηκαν δορυφόροι Orbi"
bh_orbi_move_closer="Μετακινήστε τους δορυφόρους Orbi πιο κοντά στο δρομολογητή Orbi."
bh_orbi_skip_mark="Παράλειψη"
bh_orbi_1_satellite="Εντοπίστηκε ένας δορυφόρος Orbi"
bh_orbi_2_satellite="Εντοπίστηκαν δύο δορυφόροι Orbi"
bh_orbi_3_satellite="Εντοπίστηκαν τρεις δορυφόροι Orbi"
bh_orbi_4_satellite="Εντοπίστηκαν 4 δορυφόροι Orbi"
bh_orbi_setup_mark="ΡΥΘΜΙΣΗ"
bh_orbi_setup_satellite="Εγκατάσταση δορυφόρων Orbi"
...
bh_orbi_setting_satellite="Γίνεται εγκατάσταση των δορυφόρων Orbi"
bh_orbi_success_conn="Επιτυχής σύνδεση στο Internet"
bh_orbi_success_conn_msg="Συνδεθήκατε στο Internet με επιτυχία."
bh_orbi_done_mark="ΤΕΛΟΣ"
bh_orbi_welcome="Καλώς ήλθατε στο Orbi"
bh_orbi_welcome_msg1="Ο δρομολογητής Orbi πρέπει να διαμορφωθεί για πρώτη φορά."
bh_orbi_welcome_msg2="Για να συνεχίσετε, βεβαιωθείτε ότι ο δρομολογητής Orbi είναι συνδεδεμένος στο Internet με καλώδιο Ethernet."
bh_orbi_important_msg_1="Για να μην υπάρξει διένεξη με τον πάροχο υπηρεσιών Internet, η διεύθυνση IP του δρομολογητή Orbi ενημερώθηκε σε "
bh_orbi_important_msg_2="."
bh_orbi_continue_mark="ΣΥΝΕΧΕΙΑ"
bh_orbi_personalizing="Προσαρμογή του δρομολογητή Orbi"
...
bh_orbi_sync="Για να προσθέσετε επιπλέον δορυφόρο Orbi στο υπάρχον δίκτυο Orbi WiFi. Μέσα σε δύο λεπτά, πατήστε αρχικά το κουμπί <b>Sync</b> (Συγχρονισμός) στο δρομολογητή και μετά το αντίστοιχο κουμπί στον πρόσθετο δορυφόρο."
...
bh_mode_general="Εντοπίσαμε ότι προσπαθείτε να εγκαταστήσετε το νέο σας δρομολογητή Orbi πίσω από διαφορετική πύλη, για παράδειγμα την DSL ή την πύλη καλωδίου από τον πάροχο υπηρεσιών Διαδικτύου. Συνήθως μια πύλη παρέχει επίσης μια λειτουργία WiFi ή φωνής μέσω διαδικτύου (VoIP). Μπορείτε να εγκαταστήσετε το δρομολογητή Orbi σε δύο διαφορετικούς τρόπους λειτουργίας."
bh_ap_desc1="Η λειτουργία σημείου πρόσβασης είναι η καλύτερη επιλογή αν θέλετε να χρησιμοποιήσετε το νέο σας δρομολογητή Orbi για να πετύχετε καλύτερη απόδοση του WiFi από ότι σας παρέχει η υπάρχουσα πύλη. Συνίσταται η απενεργοποίηση της λειτουργίας WiFi στην υπάρχουσα πύλη σας, αν διαθέτει λειτουργία Wi-Fi. Με αυτήν τη λειτουργία, μπορείτε να συνδέετε ενσύρματες συσκευές στην πύλη και να συνδέετε ενσύρματες συσκευές και συσκευές Wi-Fi στο νέο σας δρομολογητή Orbi. Σε αυτήν τη λειτουργία, από προεπιλογή, η διεύθυνση IP του νέου σας δρομολογητή Orbi εκχωρείται δυναμικά από την πύλη σας και πιθανώς δεν θα είναι 192.168.1.1. Ωστόσο, θα μπορείτε να χρησιμοποιήσετε τη διεύθυνση URL <a href='http://orbilogin.com' target='_blank'>http://orbilogin.com</a> για πρόσβαση στο GUI διαχείρισης του δρομολογητή από μια συσκευή που είναι συνδεδεμένη στο δρομολογητή. Ορισμένες <a href='BRS_orbi_router_function.html' target='_blank'>λειτουργίες δρομολογητή</a> δεν είναι διαθέσιμες σε αυτήν τη λειτουργία. Εάν θέλετε να χρησιμοποιήσετε τις συγκεκριμένες λειτουργίες, πρέπει να χρησιμοποιήσετε τη λειτουργία δρομολογητή."
bh_ap_sel_desc="Αυτή η λειτουργία είναι κατάλληλη για εύκολη ρύθμιση, εάν έχουν ήδη συνδεθεί συσκευές στον υπάρχοντα δρομολογητή ή στην υπάρχουσα πύλη σας ή εάν θέλετε να χρησιμοποιήσετε αυτόν το νέο δρομολογητή Orbi για επέκταση της κάλυψης WiFi. Ορισμένες <a href='BRS_orbi_router_function.html' target='_blank'>λειτουργίες δρομολογητή</a> δεν είναι διαθέσιμες κατά τη λειτουργία σημείου πρόσβασης."
bh_router_desc1="Αυτή η λειτουργία διαμορφώνει το νέο σας δρομολογητή Orbi ως κανονικό δρομολογητή WiFi πίσω από την πύλη σας και δημιουργεί ένα ξεχωριστό δίκτυο πίσω από την πύλη σας. Για να επωφεληθείτε στο έπακρο από αυτές τις σύνθετες λειτουργίες του δρομολογητή, συνίσταται η χρήση της λειτουργίας δρομολογητή. Στη λειτουργία δρομολογητή, η μοναδική συσκευή που μπορεί να συνδεθεί στην υπάρχουσα πύλη σας είναι ο νέος σας δρομολογητής Orbi. Πρέπει να συνδέσετε όλες τις συσκευές σας στο νέο δρομολογητή Orbi. Εάν η υπάρχουσα πύλη σας διαθέτει λειτουργία WiFi, απενεργοποιήστε την."
bh_router_sel_desc="Με αυτήν τη λειτουργία μπορείτε να επωφεληθείτε από τις <a href='BRS_orbi_router_function.html' target='_blank'>λειτουργίες του δρομολογητή</a> Orbi. Ο δρομολογητής Orbi ρυθμίζεται ως κανονικός δρομολογητής WiFi πίσω από τον δρομολογητή ή την πύλη που ήδη υπάρχει. Αυτή η λειτουργία απαιτεί τη σύνδεση όλων των συσκευών στο νέο δρομολογητή Orbi και όχι στην υπάρχουσα πύλη."
...
bh_must_enter_passwd="Πρέπει να εισαγάγετε έναν κωδικό πρόσβασης."
bh_must_change_passwd="Δεν μπορείτε να χρησιμοποιήσετε τον προεπιλεγμένο κωδικό πρόσβασης διαχείρισης. Πρέπει να αλλάξετε τον κωδικό πρόσβασης διαχείρισης."
bh_passwd_condition="Συνιστούμε ο κωδικός πρόσβασής σας να πληροί τις παρακάτω προϋποθέσεις:"
bh_password_reset_conditions5_1="Περιλαμβάνει 6 έως 32 χαρακτήρες"
bh_password_reset_conditions6="Δεν περιλαμβάνει περισσότερους από δύο όμοιους χαρακτήρες στη σειρά"
bh_password_reset_tip3="Επίσης, συνιστούμε ο κωδικός πρόσβασής σας να πληροί τρεις από τις παρακάτω τέσσερις προϋποθέσεις:"
...
bh_password_reset_conditions1="Τουλάχιστον ένα κεφαλαίο γράμμα"
bh_password_reset_conditions2="Τουλάχιστον ένα πεζό γράμμα"
bh_password_reset_conditions3="Τουλάχιστον ένας αριθμός"
bh_password_reset_conditions4="Τουλάχιστον ένας ειδικός χαρακτήρας, όπως @#&..."
bh_secure_passwd="Ασφαλίστε τον κωδικό πρόσβασής σας"
bh_recommend_passwd_protect="Ο κωδικός πρόσβασής σας δεν είναι ασφαλής. Συνιστούμε να αλλάξετε τον κωδικό πρόσβασής σας σε ισχυρότερο κωδικό πρόσβασης που πληροί τις απαιτήσεις μας για τον κωδικό πρόσβασης. Ένας ισχυρότερος κωδικός πρόσβασης προστατεύει το δίκτυό σας από εξωτερικές απειλές."
bh_orbi_skip_mark="Παράλειψη"
bh_password_reset="Επαναφορά κωδικού πρόσβασης δρομολογητή"
bh_verify_passwd_reset="Επαληθεύσαμε το αίτημά επαναφοράς του κωδικού πρόσβασής σας. Εισαγάγετε έναν νέο κωδικό πρόσβασης παρακάτω, συμπληρώστε τα άλλα πεδία και, στη συνέχεια, κάντε κλικ στο κουμπί <b>Επόμενο</b>."
bh_orbi_connect_new_ssid="Connect to new SSID"
bh_password_length_error="Ο κωδικός πρόσβασης πρέπει να αποτελείται από έξι ή περισσότερους χαρακτήρες."
bh_app_install_description1="Για ταχύτερη ρύθμιση, κατεβάστε το Orbi App από το "
bh_app_install_description2="Μεταβείτε στο Orbi-App.com και κατεβάστε το Orbi App στο κινητό σας τηλέφωνο ή συσκευή tablet μέσω σύνδεσης δεδομένων κινητής τηλεφωνίας για να ολοκληρώσετε τη ρύθμιση του δικτύου Wi-Fi."
bh_app_install_description3="Για ταχύτερη ρύθμιση, κατεβάστε το Nighthawk App από το "
bh_app_install_description4="Μεταβείτε στο Nighthawk-App.com και κατεβάστε τo το Nighthawk App στο κινητό σας τηλέφωνο ή συσκευή tablet μέσω σύνδεσης δεδομένων κινητής τηλεφωνίας για να ολοκληρώσετε τη ρύθμιση του δικτύου Wi-Fi."
bh_app_install_next="Αν δεν διαθέτετε συμβατό smartphone, κάντε κλικ εδώ"

//mobile
bh_mobile_pin="Το PIN είναι μια συμβολοσειρά 4 ψηφίων."
bh_mobile_puk="Το PUK είναι μια συμβολοσειρά 8 ψηφίων."
bh_unlock_code="Καταχωρίστε τον κωδικό ξεκλειδώματος (Unlock) που σας παρέχει ο πάροχος ευρυζωνικών υπηρεσιών σας και κάντε κλικ στο κουμπί <strong>Επόμενο</strong>"
bh_pin_code="Κωδικός PIN"
bh_puk_code="Κωδικός PUK"
bh_isp_configure="Καταχωρίστε τα στοιχεία διαμόρφωσης του παρόχου υπηρεσιών"
bh_type_auth="Τύπος ταυτοποίησης"
bh_type_auth_none="Καμία"
bh_type_auth_pap="Pap"
bh_type_auth_chap="Chap"
bh_type_auth_chapv2="MsChapV2"
bh_no_wan_mobilemag="No Ethernet Cable and SIM Card Is Plugged into the Orbi Router Internet Port"
bh_sim_insert="Or SIM card is inserted correctly."
bh_pin_code_unlock="Enter PIN Code to unlock SIM"
bh_puk_code="Κωδικός PUK"
bh_puk_get_way="Find PUK code on the back of SIM card holder or call Internet service provider."
bh_mobile_scan="Wizard is performing quick scan of mobile network; please wait"
bh_enable_orange_tv="Ενεργοποίηση Orange TV"
bh_orange_pppoe="Orange France PPPoE"
bh_orange_dhcp="Orange France DHCP"
bh_singtel_singa_dhcp="SingTel Singapore DHCP"
bh_unifi_malaysia_dhcp="Unifi Malaysia DHCP"
bh_maxis_malaysia_dhcp="Maxis Malaysia DHCP"
bh_movi_spain_dhcp="Movistar Spain PPPoE"
bh_orange_spain_dhcp="Orange Spain DHCP"
bh_voda_spain_dhcp="Vodafone Spain PPPoE"
bh_orange_france="Orange France"
bh_my_isp="Προφίλ παρόχου υπηρεσιών Διαδικτύου"
bh_select_isp="επιλογή παρόχου υπηρεσιών Διαδικτύου (ISP)"
bh_select_my_isp_list="Θέλω να επιλέξω ISP από τη λίστα προφίλ ISP."
bh_mobile_modem_restart="If you are setting up this LTE gateway on a cable internet, please turn your cable modem off, remove and reinsert the backup battery if your cable modem has one, and back on. After the power cycle wait for two minutes for the cable modem to complete the reboot before clicking on the [NEXT] button to continue the installation."
