...
sim_head="SIM Settings"
pin_msg="Enable or Disable the PIN Code"
disable_mark="Disabled"
enable_mark="Enabled"
...
ether_port="Ethernet Port"
ether_net_type="Network Type"
broadband_modem="Mobile Broadband Modem"
modem_sw_ver="Modem SW version"
modem_driver_ver="Modem driver version"
modem_imsi="IMSI"
...
mobile_mode_failover="Use WAN Ethernet with mobile as back up in case of failure"
...
led_control="LED Lighting Controls"
light_brightness ="LED Lighting Brightness"
light_topsc ="Schedule LED Lighting"
light_period ="The LEDs are scheduled to turn on during the following times"
light_onoff ="LED Lighting Schedule"
led_onoff ="When to turn on LEDs:"
led ="LED"
ledoff ="LED Off"
led_tm_err1 ="The start time can’t be the same or later than the end time."
led_confilct ="The schedule you set conflicts with the existing schedule."
led_switch_onoff="LED On/Off"
brightness="Brightness"
schedule_ntp_warning="The NTP service for your Orbi router failed or is disabled. The LED lighting schedule cannot be configured."
sync_mark="SYNC"
enabled="Enabled"
disabled="Disabled"
sync_button="Sync Button"
sync_btn_warning="To prevent an unauthorized user from connecting to your Orbi Outdoor satellite, make sure that your satellite's Sync button is disabled before placing your satellite outdoors."
led_max_rules="The router can support only 20 periods."
sync_your_satellite="Sync Your Satellite"
sync_success_amber="The Orbi router and satellite successfully synced, and the connection between the router and satellite is fair. Consider moving the Orbi satellite closer to the Orbi router."
sync_wait="Please wait, it might take up to 6 minutes to sync and configure your satellite."
...
circle_title="Enable Smart Parental Controls on Your Router"
...
circle_info1="To complete installation of Smart Parental Controls on your router, download the Circle app on your mobile phone: <a href='https://www.netgear.com/parental-controls' target='__blank'>www.netgear.com/parental-controls</a>"
circle_info_title="Circle Parental Control Info"
circle_info_agent="Agent version"
circle_info_app="APP Database version"
circle_stander_title="Standard Parental Controls."
circle_open="Open DNS parental controls."
circle_stander_description1="You can enable only one parental control service at a time."
circle_stander_description2="After you enable a parental control service, click the <b>Apply</b> button to save your settings."
circle_stander_description3="To turn off all parental control services, set each service to <b>Disabled</b> and click the <b>Apply</b> button."
circle_only_title="Enable Only One Parental Control Service"
circle_only_description1="If you enable one service, the other service is disabled."
circle_only_description2="Do you want to continue?"
circle_only_alert="You can enable only one parental control service at a time."
circle_enable="Enabled"
circle_enable_title="Enable Smart Parental Controls on Your Router"
...
circle_never_remind="Never remind me again."
circle_enable_mark="ENABLE"
circle_skip_mark="Skip"
...
circle_enable_title_short="Smart Parental Controls"
circle_enable_description1="Balance internet usage"
circle_enable_description2="Schedule time limits on apps and websites"
circle_enable_description3="Set age-appropriate filters"
circle_enable_description4="Keep your family safe online at home or away"
...
mobile_auto_mode="Automatic (4G or 3G)"
mobile_note="Note: This user name and password is not the same as the router's admin user name and password."
mobile_roam_auto ="Roaming automatically"
mobile_pin="A PIN is a string of 4 digits."
mobile_puk="A PUK is a string of 8 digits."
mobile_apn_empty="The APN cannot be empty"
mobile_apn_len="APN should be 64 characters or less"
signal_quality="Received Signal Quality(in dbm)"
mobile_band="Band"
lac="LAC"
cell_id="Cell ID"
roaming_state="Roaming State"
connect_duration="Connection Duration"
...
thank_login_info="Thank you for purchasing Netgear's Orbi Wireless-N Router. Be sure to use the Firmware Upgrade periodically to take advantage of improvements and feature additions NETGEAR offers for this product.<BR><BR>To take advantage of the Wireless-N feature offered by the router, use a wireless adapter that displays this logo."
thank_login_info_RangeMax="Thank you for purchasing Netgear's Orbi RangeMax (TM) Wireless-N 600 Router. Be sure to use the Firmware Upgrade periodically to take advantage of improvements and feature additions NETGEAR offers for this product.<BR><BR>To take advantage of the Wireless-N feature offered by the router, use a wireless adapter that displays this logo."
...
wlan_mode_866="Up to 866.7 Mbps"
fw_is_incompatible="One of your Orbm is running incompatible version. Click here to upgrade it"
orbi_router_head="Orbi Router"
ORT_001="Orbi can generate a new hidden password to improve security for its backhaul connection."
ORT_002="WARNING: Generating a new password might cause the Orbi satellite to lose connection from the Orbi router. To reconnect, use the <b>Sync</b> button."
ORT_005="Satellite"
ORT_007_1="Orbi satellite "
ORT_007_2=" is not connected to the Obri router."
ORT_008="If you continue, you must use the <b>Sync</b> button to reconnect the Orbi satellite to the Orbi router."
ORT_010="Online Update"
ORT_011="Manual Update"
ORT_012="Check if a new firmware version is available on the Internet."
ORT_013="Updating"
ORT_014="Downloading"
ORT_015="No new firmware available"
ORT_016="Update"
ORT_017="Update failed"
ORT_018="Number of Satellites:"
ORT_020="Backhaul"
orbi_backhaul_pwd="Backhaul Password"
orbi_noshow_again="Do not show this again"
orbi_model_name="Model Name"
orbi_router="Router"
ap_work="<b>Note:</b>After you click Apply,this device will change to a new IP assigned by your existing router,therefore this web page might not be available. Please close and restart web browser to http://orbilogin.com/ again."
...
rae_learn_ap="<p>If you want to use the new router to get better WiFi performance beyond what you have with your existing gateway, access point mode is the easiest way to do that. NETGEAR recommends that you disable the WiFi function on your existing gateway, if it has WiFi functionality. With this mode, you can connect wired devices to the gateway and connect wired and WiFi devices to your new NETGEAR router.  In this mode, by default, the new router's IP address is assigned by your gateway dynamically and is unlikely to be 192.168.1.1. However, you can still use the URL <a class='linktype' target='_blank' href='http://orbilogin.com'>http://orbilogin.com</a> to access the router's management GUI from a device connected to the router. Some router functions are not available in this mode, and you must use router mode if you want to use those functions.</p>"
...
h_attach_device="<body bgcolor=#0099cc ><P><font size=4><B>Attached Devices Help</B></font></P><p>This page shows the IP address, device name, MAC (Media Access Control) address, and connection type for each computer attached to the router. <p>To update this page and refresh the list of currently attached devices, click the <b>Refresh</b> button.<p>To manually change the new device name, click the device name.<p></body>"
h_attach_device_added="To block devices from accessing your network or allow devices to access your network, click the <b>Access Control</b> link in the top right corner of this page to go to the Access Control page and make changes."
...
h_wladv="<body bgColor=#0099cc><P><font size=4><B>Advanced Wireless Help</B></font></P><P><B>Warning: </B>The wireless router is already configured with the optimum settings. Do not alter these settings unless directed by NETGEAR support. Incorrect settings might disable the wireless router unexpectedly.<HR><A name=settings></A><P><B>Wireless Router Settings</B></P><P><B>NOTE:</B> To ensure proper agency compliance and compatibility between similar products in your area, the operating channel and region must be set correctly. <a name=Region></a><P>Region<P>Select your region from the drop-down list. This field displays the region of operation for which the wireless interface is intended. It might not be legal to operate the router in a region other than the region shown here. If your country or region is not listed, please check with your local government agency or check the NETGEAR website for more information about which channels to use.<P>Enable SSID Broadcast<P>If this feature is enabled, the wireless router will broadcast its name (SSID) to all wireless stations. Stations that have no SSID (or a null value) can then adopt the correct SSID for connections to this access point.</p><P>Enable 20/40 MHz Coexistence</P><P>Disabling this option allows your 2.4GHz wireless to stay in supporting the max speed. Enabling this option may reduce the max speed of your 2.4GHz wireless to the half when there is another wireless network detected in your environment; this is to avoid inteference between wireless networks and to get along with other wireless networks in the environment.</P><P>Fragmentation Threshold, CTS/RTS Threshold, Preamble Mode</P><P>These settings are reserved for wireless testing and advanced configuration only. Do not change these settings.</P><a name=tra_pow_ctl></a><p>Transmit Power Control<p>The 100% means this router uses the original transmit power setting to transmit wireless packets. Reduce the transmit power level can save power consumption of this device if wireless radio is on, however, it also reduces the wireless coverage. If you want to have whole home coverage, NETGEAR recommend you leave it 100%.</p><a name=backhaul></a><P>Backhaul Password</P><P>The Orbi backhaul password is used to encrypt the data transmission between two Orbi devices. You can generate a new password whenever you want.</P></body>"
h_wlan="<body bgColor=#0099cc><P><font size=4><B>Wireless Help</B></font></P><P><B>Placement of the Router to Optimize Wireless Connectivity</B><P>The operating distance or range of your wireless connection can vary significantly based on the physical placement of the router. For best results, place your router:<UL><LI>Near the center of the area in which your PCs will operate.<LI>In an elevated location such as a high shelf.<LI>Away from potential sources of interference, such as PCs, microwave ovens, and cordless phones.<LI>Away from large metal surfaces. </LI></UL><P><B>Note:</B> Failure to follow these guidelines can result in significant performance degradation or inability to wirelessly connect to the router.</P><HR><A name=network></A><P><B>Wireless Network</B></P><P>Name (SSID)<P>Enter a value of up to 32 alphanumeric characters. The same name (SSID) must be assigned to all wireless devices in your network. The default SSID is ORBIxx, but NETGEAR strongly recommends that you change your network's name (SSID) to a different value. This value is case-sensitive. For example, NETGEAR is not the same as NETGEAr.</p><p>Channel<P>This field determines which operating frequency will be used. It should not be necessary to change the wireless channel unless you notice interference problems with another nearby access point.</P><HR><A name=security></A><p><b>Security Options</b></p><UL><LI>None - no data encryption<LI>WPA2-PSK [AES] - Wi-Fi Protected Access version 2 with Pre-Shared Key, use WPA2-PSK standard encryption with the AES encryption type<LI>WPA-PSK [TKIP] + WPA2-PSK [AES] - Allow clients using either WPA-PSK [TKIP] or WPA2-PSK [AES]</UL><p>To achieve the best performance with 11N wireless adapters under robust security network, NETGEAR recommends that you change your network's security option to WPA2-PSK.</p><HR><A name=wpa2-psk></A><p><b>Security Encryption (WPA2-PSK)</b></p><p>WPA2 is a newer version of WPA. Only select this if all the wireless clients in your network support WPA2. If selected, you must use AES encryption, and enter the WPA passphrase (Network key). Enter a word or group of printable characters in the Passphrase box. The Passphrase must be constituted of either 8 to 63 ASCII characters or exactly 64 hex digits. A hex digit is one of the following characters: <br>0, 1, 2, ..., 8, 9, A, B, C, D, E, and F. </p><HR><A name=wpa-psk+wpa2-psk></A><p><b>Security Encryption (WPA-PSK + WPA2-PSK) </b></p><p>This selection allows clients to use either WPA (with TKIP, broadcast packets also use TKIP.) or WPA2 (with AES). If selected, encryption must be TKIP + AES. The WPA passphrase (Network key) must also be entered. To reach maximum wireless performance, the 11N clients must connect to this router using WPA2-PSK(with AES) . For clients connecting in WPA-PSK( with TKIP), the maximum wireless speed will be at 802.11g. Enter a word or group of printable characters in the Passphrase box. The Passphrase must be constituted of either 8 to 63 ASCII characters or exactly 64 hex digits. A hex digit is one of the following characters: <br>0, 1, 2, ..., 8, 9, A, B, C, D, E, and F. </p><HR><A name=wpawpa2></a><p><b>To Save Or Cancel Changes</b></p><p>Click <b>Apply</b> to have your changes take effect. <br>Click <b>Cancel</b> to return to the previous settings. </p></body>"
bluebar="<TR><TD colspan=2><hr class=blueBar /></TD></TR>"
auto_major_upg="Allow Orbi to automatically install major updates"
...
auto_major_upg_alert="Major updates allow your Orbi to have the latest features and be compatible with future NETGEAR products. NETGEAR recommends keeping this option enabled. Do you still want to proceed?"
router_faq="FAQ"
add_orbi_satellite="Add Orbi Satellite"
place_your_satellite="Place Your Satellite"
add_first_step="<TR><TD colspan=2><b>If this is the first Orbi satellite you are adding to your Orbi network, follow these steps:</b></TD></TR><TR><TD colspan=2 style=\"padding:5px;\">Place your Orbi satellite in the middle of your house to get the best WiFi coverage.</TD></TR><TR><TD colspan=2 style=\"padding:5px;\">Connect the Orbi satellite to a power source. The Power LED on the back of the Orbi satellite lights green. If the Power LED does not light, press the Power On/Off button.</TD></TR>"
add_new_step="<TR><TD colspan=2><b>If you already set up an Orbi router and satellite on your Orbi network, follow these steps:</b></TD></TR><TR><TD colspan=2 style=\"padding:5px;\">Place your Orbi satellite in a corner of your house that is far away from your existing Orbi router and satellite, but still within range or your Orbi router and satellite. If your house has multiple floors, place your Orbi satellite on a different floor than your existing Orbi router and satellite.</TD></TR><TR><TD colspan=2 style=\"padding:5px;\">Connect the Orbi satellite to a power source. The Power LED on the back of the Orbi satellite lights green. If the Power LED does not light, press the Power On/Off button.</TD></TR>"
satellite_wait="Wait about two minutes for the Orbi satellite's ring LED to light solid white. Then, press the Sync button on the back of your Orbi satellite."
press_sync="Then, press the Sync button on this screen."
sync="SYNC"
satellite_lights="The Orbi satellite's ring LED lights white, then lights one of the following colors for about three minutes and then turns off:"
sync_success="The Orbi router and satellite successfully synced, and the connection between the router and satellite is good."
amber="Amber"
magenta="Magenta"
sync_fail="The Orbi router and satellite failed to sync. Move the satellite closer to the router and try again."
satellite_setup_success="Satellite setup successfully"
satellite_setup_fail="Satellite setup failed"
usb_share_print_prompt8="1. Using a USB cable, connect one end to the Orbi Router's or Orbi Satellite's USB port and the other end to the printer's USB port."
usb_share_print_prompt9="2. Install the USB printer driver on each computer that will use the printer."
usb_share_print_prompt10="If you don’t have the driver installed, it’s usually available through the printer manufacturer."
usb_share_print_prompt11="3. On each computer that will use the printer, download the NETGEAR USB Control Center utility from <a class='linktype' target='_blank' href='http://www.netgear.com/readyshare'>http://www.netgear.com/readyshare</a>"
usb_share_print_prompt12="ReadySHARE Printer lets you share a USB printer that is connected to a USB port on your Orbi Router or Orbi Satellite. You can share this USB printer among the Windows and MAC computers on your network."
coun_md_6="Middle East(Qatar)"
tos_title="Terms of Services"
tos_agree="I agree to the Terms and Conditions and understand that NETGEAR will upgrade my Orbi devices automatically."
h_wladv_2="<body bgColor=#0099cc><P><font size=4><B>Advanced Wireless Help</B></font></P><P><B>Warning: </B>The wireless router is already configured with the optimum settings. Do not alter these settings unless directed by NETGEAR support. Incorrect settings might disable the wireless router unexpectedly.<HR><A name=settings></A><P><B>Wireless Router Settings</B></P><P><B>NOTE:</B> To ensure proper agency compliance and compatibility between similar products in your area, the operating channel and region must be set correctly. <a name=Region></a><P>Region<P>Select your region from the drop-down list. This field displays the region of operation for which the wireless interface is intended. It might not be legal to operate the router in a region other than the region shown here. If your country or region is not listed, please check with your local government agency or check the NETGEAR website for more information about which channels to use.<P>Enable SSID Broadcast<P>If this feature is enabled, the wireless router will broadcast its name (SSID) to all wireless stations. Stations that have no SSID (or a null value) can then adopt the correct SSID for connections to this access point.</p><P>Enable 20/40 MHz Coexistence</P><P>Disabling this option allows your 2.4GHz wireless to stay in supporting the max speed. Enabling this option may reduce the max speed of your 2.4GHz wireless to the half when there is another wireless network detected in your environment; this is to avoid inteference between wireless networks and to get along with other wireless networks in the environment.</P><P>Fragmentation Threshold, CTS/RTS Threshold, Preamble Mode</P><P>These settings are reserved for wireless testing and advanced configuration only. Do not change these settings.</P><a name=backhaul></a><P>Backhaul Password</P><P>The Orbi backhaul password is used to encrypt the data transmission between two Orbi devices. You can generate a new password whenever you want.</P></body>"
