...
bh_account_msg="The admin password is used to log in to your Orbi router’s web interface. Secure your network by changing the admin password."
...
bh_password_null="Password cannot be blank."
...
bh_orbi_nowan="No Ethernet Cable Is Plugged into the Orbi Router Internet Port"
bh_orbi_nowan_msg="Make sure the cable is securely plugged into both the boradband modem port and the Orbi router Internet port."
...
bh_orbi_help_choice1="I want the NETGEAR installation assistant to determine the appropriate settings for my environment and configure my Orbi router automatically."
...
bh_orbi_help_choice3="I want to load saved Orbi router configuration settings."
bh_orbi_nowan_msg1="Make sure that the cable is securely plugged into both the broadband modem port and the Orbi router Internet port."
...
bh_orbi_cannot_find_ip_msg3="The Ethernet cable connecting your modem to your Orbi router is not fully inserted, or inserted in the wrong place."
bh_orbi_cannot_find_ip_msg4="Make sure the Ethernet cable is securely plugged in to the modem port and the Orbi router Internet port."
...
bh_orbi_restore="Restoring Orbi Router Settings"
bh_orbi_restore_wait="This process can take a few minutes."
bh_orbi_restore_msg1="Browse to the Orbi router backup settings file you previously saved, and click the <b>NEXT</b> button to proceed."
bh_orbi_sel_file="Select File"
bh_orbi_browse_mark="BROWSE"
bh_orbi_back_mark="BACK"
bh_orbi_cannot_connect_internet="The Orbi router cannot connect to the Internet with the current settings."
bh_orbi_cannot_connect_internet_msg1="Review the following items:"
bh_orbi_cannot_connect_internet_msg2="Check that the cable connections are correct. For more information, see your Orbi router's quick start guide."
...
bh_orbi_ap_tips="Note: We detected an existing router or gateway on your network. You can still connect your Orbi router to your network and it will be set in router mode."
bh_orbi_ap_title="Existing Router or Gateway Detected"
bh_orbi_check_update="Checking for Updates"
bh_check_satellite="Checking Orbi Satellite Connection"
bh_orbi_complete="Configuration Complete"
bh_orbi_complete_msg1="Your new admin and WiFi credentials are displayed below."
bh_orbi_print="PRINT WIFI CREDENTIALS"
bh_orbi_no_satellite="No Orbi Satellites Detected"
bh_orbi_move_closer="Move your Orbi satellites closer to your Orbi router."
bh_orbi_skip_mark="SKIP"
bh_orbi_1_satellite="One Orbi Satellite Detected"
bh_orbi_2_satellite="Two Orbi Satellites Detected"
bh_orbi_3_satellite="Three Orbi Satellites Detected"
bh_orbi_4_satellite="4 Orbi Satellites Detected"
bh_orbi_setup_mark="SETUP"
bh_orbi_setup_satellite="Setup Orbi Satellites"
bh_orbi_setup_satellite_msg="Let’s check your satellites' connection. Place your satellites and turn them on."
bh_orbi_setting_satellite="Setting Up Orbi Satellites"
bh_orbi_success_conn="Successfully Connected to Internet"
bh_orbi_success_conn_msg="You successfully connected to the Internet."
bh_orbi_done_mark="DONE"
bh_orbi_welcome="Welcome to Orbi"
bh_orbi_welcome_msg1="Your Orbi router needs to be configured for the first time."
bh_orbi_welcome_msg2="Make sure your Orbi router is connected to Internet with an Ethernet cable to continue."
...
bh_orbi_personalizing="Personalize Your Orbi Router"
...
bh_orbi_sync="To add additional Orbi satellite to your existing Orbi WiFi network. Press the <b>Sync</b> button on the router and add-on satellite within two minutes of each other."
...
bh_type_auth="Authentication Type"
bh_type_auth_none="None"
