...
#if defined(CONFIG_NETGEAR_PUSH_BUTTON)
	netgear_push_button();
#endif

#if defined(CONFIG_NETGEAR_11AC_MESH_SPEC_PUSH_BUTTON)
	netgear_11ac_mesh_spec_push_button();
#endif

#if defined(CONFIG_NETGEAR_DOUBLE_UNION)
	netgear_double_union();
#endif
