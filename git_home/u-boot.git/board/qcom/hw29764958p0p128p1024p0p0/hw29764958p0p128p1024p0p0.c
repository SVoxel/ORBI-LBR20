...
#include <asm/errno.h>
#include "hw29764958p0p128p1024p0p0_board_param.h"
#include "hw29764958p0p128p1024p0p0.h"
...
int checkboard(void)
{
	printf("U-boot 2012.07 dni1 V0.3 for BR500 DNI HW ID: 29764958 NOR flash 0MB; NAND flash 128MB; RAM 1024MB;\n");
	return 0;
}
