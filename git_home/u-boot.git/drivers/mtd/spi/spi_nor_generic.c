...
#endif
#if defined(CONFIG_HW29765619P0P256P512P2X2P2X2P4X4PVERIZON)
...
#endif
#if defined(CONFIG_HW29766182P0P256P512P2X2P2X2P2X2P1)
#include <asm/hw29766182p0p256p512p2x2p2x2p2x2p1/smem.h>
#endif
#if defined(CONFIG_HW29766105P0P128P512P2X2P2X2)
...
#endif
#if defined(CONFIG_HW29765913P0P512P512P2X2P2X2P4X4)
#include <asm/hw29765913p0p512p512p2x2p2x2p4x4/smem.h>
#endif
#if defined(CONFIG_HW29765913P0P512P512P2X2P2X2P4X4PVERIZON)
#include <asm/hw29765913p0p512p512p2x2p2x2p4x4pverizon/smem.h>
#endif
#if defined(CONFIG_HW29765913P0P128P256P2X2P2X2P4X4)
#include <asm/hw29765913p0p128p256p2x2p2x2p4x4/smem.h>
#endif
#if defined(CONFIG_HW29765913P0P128P256P2X2P2X2P4X4PVERIZON)
#include <asm/hw29765913p0p128p256p2x2p2x2p4x4pverizon/smem.h>
#endif
#if defined(CONFIG_HW29765641P0P128P256P2X2P2X2P2X2)
#include <asm/hw29765641p0p128p256p2x2p2x2p2x2/smem.h>
#endif
#if defined(CONFIG_HW29766106P32P0P256P2X2P2X2)
