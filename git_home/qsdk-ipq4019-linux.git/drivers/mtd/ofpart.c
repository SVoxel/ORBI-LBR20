...
struct dni_nand_partition_entry dni_rbs20_nand_partition[] = {
       ...
       { 0x00f80000, 0x00300000, "language" },
       { 0x01280000, 0x01e00000, "ntgrdata" },
       { 0x03080000, 0x02800000, "firmware" },
       { 0x03080000, 0x003c0000, "kernel" },
       { 0x03440000, 0x02440000, "rootfs" },
       { 0x05880000, 0x02780000, "reserved" }
};

struct dni_nand_partition_entry dni_rbr20_nand_partition[] = {
	{ 0x00b80000, 0x00080000, "0:ART.bak" },
	{ 0x00c00000, 0x00100000, "config" },
	{ 0x00d00000, 0x00080000, "boarddata1" },
	{ 0x00d80000, 0x00040000, "boarddata2" },
	...
	{ 0x00f40000, 0x00040000, "boarddata2.bak" },
	{ 0x00f80000, 0x00300000, "language" },
	{ 0x01280000, 0x00080000, "cert" },
	{ 0x01300000, 0x09300000, "ntgrdata" },
	{ 0x0a600000, 0x03c00000, "firmware" },
	{ 0x0a600000, 0x003c0000, "kernel" },
	{ 0x0a9c0000, 0x03840000, "rootfs" },
	{ 0x0e200000, 0x01e00000, "reserved" }
};
#endif
				   ...
				   struct mtd_part_parser_data *data)
{
	...
	*pparts = kzalloc(32 * sizeof(**pparts), GFP_KERNEL);
	...
	if (strcmp(dni_model_id, "LBR20") == 0){
		dni_nand_partition = dni_rbr20_nand_partition;
		count = sizeof(dni_rbr20_nand_partition)/sizeof(struct dni_nand_partition_entry);
	}
	else {
		dni_nand_partition = dni_rbs20_nand_partition;
		count = sizeof(dni_rbs20_nand_partition)/sizeof(struct dni_nand_partition_entry);
	}
