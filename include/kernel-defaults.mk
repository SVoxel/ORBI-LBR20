...
define Kernel/Configure/Default
	cat $(LINUX_TARGET_CONFIG) > $(LINUX_DIR)/config.target;
	-[ -f $(DNI_HOME)/kernel/config.dni ] && cat $(DNI_HOME)/kernel/config.dni >> $(LINUX_DIR)/config.target;
	cp $(LINUX_DIR)/config.target $(LINUX_DIR)/.config;
