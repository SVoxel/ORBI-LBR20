...
#collect mobile
[ -f /tmp/debug_mobile_log ] && unix2dos /tmp/debug_mobile_log
[ -f /tmp/debug_mobile_log_bak ] && unix2dos /tmp/debug_mobile_log_bak

if [ "`cat /tmp/orbi_type`" = "Base" ];then
	mobile_log=debug_mobile_log*
fi
...
if [ "x$collect_log" = "x1" ];then
	zip debug-log.zip  NETGEAR_$module_name.cfg panic_log.txt /firmware_version Console-log1.txt Console-log2.txt logread-log1.txt logread-log2.txt thermal-log1.txt thermal-log2.txt basic_debug_log.txt wireless-log1.txt wireless-log2.txt wireless-client-statistic1.txt wireless-client-statistic2.txt lan.pcap wan.pcap wan_wwan0.pcap arlo.pcap soapclient/* /var/log/soapclient/* /var/log/soapapp hyt_result satellite_status hyd-restart.log wsplcd-restart.log debug_here_log_1.txt debug_here_log_2.txt dhcpd_hostlist /var/log/netscan/* device_tables/local_device_table $RADARLOG /tmp/auto_fw_upgrade_log* /tmp/soap_check_fw_log* /tmp/wifi0.caldata /tmp/wifi1.caldata /tmp/wifi2.caldata /tmp/debug_circle.zip $xagent_log $system_log $system_log2 $arlo_log1 $arlo_log2 $arlo_list $armor_log /tmp/ookla_speedtest_result /tmp/dal/d2d/* /tmp/dal_ash.log /tmp/dalh.log /tmp/upagent.log /tmp/dillog /tmp/fing_dil.log /tmp/bst.log $mobile_log
else
	zip debug-log.zip NETGEAR_$module_name.cfg  panic_log.txt /firmware_version Console-log1.txt Console-log2.txt logread-log1.txt logread-log2.txt thermal-log1.txt thermal-log2.txt wireless-log1.txt wireless-log2.txt wireless-client-statistic1.txt wireless-client-statistic2.txt basic_debug_log.txt lan.pcap wan.pcap wan_wwan0.pcap arlo.pcap soapclient /var/log/soapclient/* /var/log/soapapp hyt_result satellite_status hyd-restart.log wsplcd-restart.log debug_here_log_1.txt debug_here_log_2.txt dhcpd_hostlist /var/log/netscan/* device_tables/local_device_table $RADARLOG /tmp/auto_fw_upgrade_log* /tmp/soap_check_fw_log* /tmp/wifi0.caldata /tmp/wifi1.caldata /tmp/wifi2.caldata /tmp/debug_circle.zip $xagent_log $system_log $system_log2 $arlo_log1 $arlo_log2 $arlo_list $armor_log /tmp/ookla_speedtest_result /tmp/dal/d2d/* /tmp/dal_ash.log /tmp/dalh.log /tmp/upagent.log /tmp/dillog /tmp/fing_dil.log /tmp/bst.log
fi

cd /tmp
rm -rf debug-usb debug_cpu debug_flash debug_mem debug_mirror_on debug_session NETGEAR_$module_name.cfg panic_log.txt Console-log1.txt Console-log2.txt logread-log1.txt logread-log2.txt thermal-log1.txt thermal-log2.txt basic_debug_log.txt lan.pcap wan.pcap wan_wwan0.pcap arlo.pcap wireless-log1.txt wireless-log2.txt wireless-client-statistic1.txt wireless-client-statistic2.txt /var/log/soapapp debug_here_log_1.txt debug_here_log_2.txt debug_circle* $xagent_log $system_log $system_log2 $arlo_log1 $arlo_log2 $arlo_list $armor_log $mobile_log
